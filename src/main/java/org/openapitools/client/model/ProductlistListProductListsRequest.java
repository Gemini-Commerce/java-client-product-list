...
public class ProductlistListProductListsRequest {
   ...
   * @return the ProductlistListProductListsRequest instance itself
   */
  public ProductlistListProductListsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, productlistListProductListsRequest.tenantId) &&
        ...
        Objects.equals(this.additionalProperties, productlistListProductListsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantId, pageSize, pageToken, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ProductlistListProductListsRequest>() {
           ...
           public ProductlistListProductListsRequest read(JsonReader in) throws IOException {
             ...
             ProductlistListProductListsRequest instance = thisAdapter.fromJsonTree(jsonObj);
