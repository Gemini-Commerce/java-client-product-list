...
import GeminiCommerce.ProductList.auth.Authentication;
import GeminiCommerce.ProductList.auth.HttpBasicAuth;
import GeminiCommerce.ProductList.auth.HttpBearerAuth;
import GeminiCommerce.ProductList.auth.ApiKeyAuth;
import GeminiCommerce.ProductList.auth.OAuth;
import GeminiCommerce.ProductList.auth.RetryingOAuth;
import GeminiCommerce.ProductList.auth.OAuthFlow;
...
public class ApiClient {
     ...
     * @return a {@link GeminiCommerce.ProductList.ApiClient} object
     */
    ...
    */
     ...
     * @throws GeminiCommerce.ProductList.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws GeminiCommerce.ProductList.ApiException If fail to serialize the given object
     */
     ...
     * @throws GeminiCommerce.ProductList.ApiException If fail to read file content from response and write to disk
     ...
     * @throws GeminiCommerce.ProductList.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws GeminiCommerce.ProductList.ApiException If the response has an unsuccessful status code or
     ...
     * @throws GeminiCommerce.ProductList.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws GeminiCommerce.ProductList.ApiException If fails to update the parameters
     */
     ...
     * @throws GeminiCommerce.ProductList.ApiException If fail to serialize the request body object into a string
     */
